...
namespace GEII\StockBundle\Controller;
...
use GEII\StockBundle\Entity\Journal;
use GEII\StockBundle\Form\JournalType;
...
class JournalController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GEIIStockBundle:Journal')->findAll();

        $quantites = $em->getRepository('GEIIStockBundle:Journal')->getAllQte();

        $prixHT = $em->getRepository('GEIIStockBundle:Journal')->getPrixHT();

        $prixTTC = $em->getRepository('GEIIStockBundle:Journal')->getPrixTTC();
     ...
     * @Method("POST")
     * @Template("GEIIStockBundle:Journal:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GEIIStockBundle:Journal')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GEIIStockBundle:Journal:edit.html.twig")
     */
